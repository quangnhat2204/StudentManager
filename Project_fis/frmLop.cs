...
namespace Project_fis
{
    public partial class frmLop : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanlydiemDataSet3.tblLOP' table. You can move, or remove it, as needed.
            this.tblLOPTableAdapter.Fill(this.quanlydiemDataSet3.tblLOP);
            conn = cc.Connected();
