...
namespace Project_fis
{
    public partial class frmGiangVien : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanlydiemDataSet7.tblGIANG_VIEN' table. You can move, or remove it, as needed.
            this.tblGIANG_VIENTableAdapter.Fill(this.quanlydiemDataSet7.tblGIANG_VIEN);
            conn = cc.Connected();
        }
