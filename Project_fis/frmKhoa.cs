...
namespace Project_fis
{
    public partial class frmKhoa : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanlydiemDataSet2.tblKHOA' table. You can move, or remove it, as needed.
            this.tblKHOATableAdapter.Fill(this.quanlydiemDataSet2.tblKHOA);
            conn = cc.Connected();
