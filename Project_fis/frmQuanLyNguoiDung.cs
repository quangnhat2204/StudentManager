...
namespace Project_fis
{
    public partial class frmQuanLyNguoiDung : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanlydiemDataSet.tblLOGIN' table. You can move, or remove it, as needed.
            this.tblLOGINTableAdapter.Fill(this.quanlydiemDataSet.tblLOGIN);
            conn = cc.Connected();
        ...
        private void dgrLogin_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtConfimMk.Text = dgrLogin.CurrentRow.Cells[1].Value.ToString();
